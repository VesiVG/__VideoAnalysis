...
namespace __VideoAnalysis
{
    class Program
    {
        ...
        {
            if (picture.Image == null || (picture.Image.Width!=ff.pFrame->width || picture.Image.Height != ff.pFrame->height))
            {
            if (picture.Image != null) picture.Image.Dispose();
                picture.Image = new System.Drawing.Bitmap(ff.pFrame->width, ff.pFrame->height, System.Drawing.Imaging.PixelFormat.Format24bppRgb);
            }
